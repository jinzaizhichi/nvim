...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "vim-dadbod-completion", "cmp-vsnip", "cmp-buffer", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'undotree', 'nvim-lspconfig', 'vim-illuminate', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'spellsitter.nvim', 'nvim-notify', 'nvim-scrollview', 'which-key.nvim', 'nvim-ts-autotag', 'remember.nvim', 'todo-comments.nvim', 'surround.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
