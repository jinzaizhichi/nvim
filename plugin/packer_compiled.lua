...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "persisted.nvim", "nvim-web-devicons", "sqlite.lua", "plenary.nvim" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-vsnip", "vim-dadbod-completion", "cmp-cmdline", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'which-key.nvim', 'gitsigns.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-lspconfig', 'nvim-notify', 'nvim-scrollview', 'remember.nvim', 'surround.nvim', 'todo-comments.nvim', 'undotree', 'vim-illuminate'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'indent-blankline.nvim', 'which-key.nvim', 'gitsigns.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-lspconfig', 'nvim-notify', 'nvim-scrollview', 'remember.nvim', 'surround.nvim', 'todo-comments.nvim', 'undotree', 'vim-illuminate'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
