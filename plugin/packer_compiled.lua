...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "sqlite.lua", "persisted.nvim", "plenary.nvim", "nvim-web-devicons" },
  ...
  ["nvim-cmp"] = {
    after = { "vim-dadbod-completion", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-tabnine", "cmp-vsnip" },
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'mkdir.nvim', 'friendly-snippets', 'nvim-hlslens'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'which-key.nvim', 'nvim-lastplace', 'nvim-notify', 'nvim-scrollview', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'surround.nvim', 'todo-comments.nvim', 'copilot.vim', 'nvim-lspconfig', 'undotree', 'vim-illuminate', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'indent-blankline.nvim', 'which-key.nvim', 'nvim-lastplace', 'nvim-notify', 'nvim-scrollview', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'surround.nvim', 'todo-comments.nvim', 'copilot.vim', 'nvim-lspconfig', 'undotree', 'vim-illuminate', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'vim-python-pep8-indent', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
