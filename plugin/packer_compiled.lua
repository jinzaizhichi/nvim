...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "nvim-lspconfig", "sqlite.lua", "plenary.nvim", "nvim-web-devicons", "persisted.nvim" },
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-scrollview', 'which-key.nvim', 'surround.nvim', 'todo-comments.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'vim-illuminate', 'indent-blankline.nvim', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-colorizer.lua', 'undotree'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'friendly-snippets', 'vimcdoc', 'mkdir.nvim', 'nvim-hlslens'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-scrollview', 'which-key.nvim', 'surround.nvim', 'todo-comments.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'vim-illuminate', 'indent-blankline.nvim', 'nvim-ts-autotag', 'spellsitter.nvim', 'undotree', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]
