...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "nvim-lspconfig", "plenary.nvim", "persisted.nvim", "sqlite.lua", "nvim-web-devicons" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-path", "cmp-vsnip", "vim-dadbod-completion", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "cmp-nvim-lsp", "aerial.nvim", "lua-dev.nvim", "null-ls.nvim", "nvim-lsp-installer" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'gitsigns.nvim', 'undotree', 'indent-blankline.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-lastplace', 'nvim-scrollview', 'vim-illuminate', 'surround.nvim', 'which-key.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'todo-comments.nvim', 'gitsigns.nvim', 'undotree', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-scrollview', 'vim-illuminate', 'surround.nvim', 'which-key.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'friendly-snippets', 'vimcdoc', 'nvim-hlslens', 'mkdir.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
