...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "nvim-web-devicons", "persisted.nvim", "sqlite.lua", "plenary.nvim" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-buffer", "vim-dadbod-completion", "cmp-vsnip", "cmp-cmdline", "cmp-path" },
...
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'nvim-hlslens', 'friendly-snippets', 'mkdir.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'copilot.vim', 'gitsigns.nvim', 'todo-comments.nvim', 'nvim-lspconfig', 'indent-blankline.nvim', 'which-key.nvim', 'vim-illuminate', 'nvim-notify', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'undotree', 'surround.nvim', 'nvim-lastplace', 'nvim-ts-rainbow', 'nvim-scrollview'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'copilot.vim', 'gitsigns.nvim', 'todo-comments.nvim', 'nvim-lspconfig', 'indent-blankline.nvim', 'which-key.nvim', 'vim-illuminate', 'nvim-notify', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'undotree', 'surround.nvim', 'nvim-lastplace', 'nvim-ts-rainbow', 'nvim-scrollview'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
