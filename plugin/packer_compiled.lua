...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "sqlite.lua", "plenary.nvim", "persisted.nvim", "nvim-web-devicons" },
    loaded = true,
    only_config = true
  },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-vsnip", "cmp-buffer", "vim-dadbod-completion", "cmp-cmdline", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'remember.nvim', 'spellsitter.nvim', 'surround.nvim', 'undotree', 'todo-comments.nvim', 'which-key.nvim', 'nvim-scrollview', 'indent-blankline.nvim', 'vim-illuminate', 'nvim-notify', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'remember.nvim', 'spellsitter.nvim', 'surround.nvim', 'undotree', 'todo-comments.nvim', 'which-key.nvim', 'nvim-scrollview', 'indent-blankline.nvim', 'vim-illuminate', 'nvim-notify', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-lspconfig', 'bufferline.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
