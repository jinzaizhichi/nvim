...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "plenary.nvim", "nvim-lspconfig", "sqlite.lua", "nvim-web-devicons", "persisted.nvim" },
  ...
  ["nvim-cmp"] = {
    after = { "vim-dadbod-completion", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-vsnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "aerial.nvim", "lua-dev.nvim", "nvim-lsp-installer", "null-ls.nvim", "cmp-nvim-lsp" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-illuminate', 'indent-blankline.nvim', 'which-key.nvim', 'nvim-colorizer.lua', 'nvim-scrollview', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'surround.nvim', 'todo-comments.nvim', 'undotree', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'mkdir.nvim', 'nvim-hlslens', 'friendly-snippets', 'vimcdoc'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-colorizer.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-illuminate', 'indent-blankline.nvim', 'which-key.nvim', 'nvim-lastplace', 'nvim-scrollview', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'surround.nvim', 'todo-comments.nvim', 'undotree', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
