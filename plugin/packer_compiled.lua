...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-vsnip", "vim-dadbod-completion", "cmp-buffer", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "nvim-lsp-installer", "null-ls.nvim", "aerial.nvim", "cmp-nvim-lsp" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-lastplace', 'nvim-scrollview', 'vim-illuminate', 'surround.nvim', 'todo-comments.nvim', 'which-key.nvim', 'undotree', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-ts-rainbow'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-colorizer.lua', 'nvim-scrollview', 'vim-illuminate', 'surround.nvim', 'todo-comments.nvim', 'which-key.nvim', 'undotree', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-ts-rainbow'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
