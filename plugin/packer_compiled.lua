...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "nvim-web-devicons", "nvim-lspconfig", "sqlite.lua", "plenary.nvim", "persisted.nvim" },
  ...
  ["nvim-cmp"] = {
    after = { "vim-dadbod-completion", "cmp-vsnip", "cmp-cmdline", "cmp-path", "cmp-buffer" },
  ...
  ["nvim-lsp-installer"] = {
    after = { "nvim-lightbulb", "fidget.nvim" },
  ...
  ["nvim-lspconfig"] = {
    after = { "cmp-nvim-lsp", "aerial.nvim", "nvim-lsp-installer", "null-ls.nvim", "lua-dev.nvim" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'nvim-autopairs', 'vim-python-pep8-indent'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-visual-multi'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-illuminate', 'indent-blankline.nvim', 'gitsigns.nvim', 'todo-comments.nvim', 'undotree', 'which-key.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-scrollview', 'surround.nvim', 'nvim-colorizer.lua'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'mkdir.nvim', 'friendly-snippets', 'nvim-hlslens', 'vimcdoc'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-illuminate', 'indent-blankline.nvim', 'gitsigns.nvim', 'todo-comments.nvim', 'undotree', 'which-key.nvim', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-scrollview', 'surround.nvim', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]
